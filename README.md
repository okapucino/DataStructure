...
| --- | --- |
| [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/okapucino/DataStructure/blob/main/Project_sederhana_pengelolaan_nilai.ipynb) | `pengelolaan_nilai_colab` <br> [Sistem Pengelolaan Nilai Mahasiswa (Array)](#1-sistem-pengelolaan-nilai-mahasiswa-sederhana) |
...
1. **Inisialisasi**: Mendeklarasikan array kosong dengan sintaks `nilai_mahasiswa =[]`.
...
3. **Traversal (Pembacaan Data)**: Python mengevaluasi data array secara langsung saat kita memasukkannya ke dalam fungsi bawaan seperti `max()`, `min()`, `sum()`, atau dengan List Comprehension `[n for n in nilai_mahasiswa]`.
